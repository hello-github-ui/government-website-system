                ...
                <div class="card-body">
                    <form action="/admin/role/edit?id=<?= $role['id'] ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="role_desc" class="form-control" rows="2"><?= htmlspecialchars($role['role_desc'] ?? '') ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select">
                                <option value="1" <?= $role['status'] ? 'selected' : '' ?>>启用</option>
                                <option value="0" <?= !$role['status'] ? 'selected' : '' ?>>禁用</option>
                            </select>
                        </div>
